...
static int camcorder_check_flag = 0;
...
static struct isx005_enum_framesize isx005_framesize_list[] = {
	...
	{ ISX005_OPRMODE_IMAGE, ISX005_CAPTURE_1MP, 1280, 960 },
...
#if 1
	filp = filp_open("/sdcard/isx005.h", O_RDONLY, 0);
#else
...
static int isx005_set_dzoom(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	...
	int index = state->snapshot_width;
	int err = 0;

	isx005_msg(&client->dev, "isx005_set_dzoom: state->snapshot_width = %d, value = %d\n", state->snapshot_width, ctrl->value);

	state->dzoom = ctrl->value;

	switch (ctrl->value) {
		case 0:
		case 20:
		case 30:
			if (index >= 1280 && !camcorder_check_flag)
				err = isx005_i2c_write(sd, isx005_1280x960_Zoom_00, sizeof(isx005_1280x960_Zoom_00) / sizeof(isx005_1280x960_Zoom_00[0]), "isx005_1280x960_Zoom_00");
			else
				err = isx005_i2c_write(sd, isx005_640x480_Zoom_00, sizeof(isx005_640x480_Zoom_00) / sizeof(isx005_640x480_Zoom_00[0]), "isx005_640x480_Zoom_00");
			break;
		case 1:
			if (index >= 1280 && !camcorder_check_flag)
				err = isx005_i2c_write(sd, isx005_1280x960_Zoom_01, sizeof(isx005_1280x960_Zoom_01) / sizeof(isx005_1280x960_Zoom_01[0]), "isx005_1280x960_Zoom_01");
			else
				err = isx005_i2c_write(sd, isx005_640x480_Zoom_01, sizeof(isx005_640x480_Zoom_01) / sizeof(isx005_640x480_Zoom_01[0]), "isx005_640x480_Zoom_01");
			break;
		case 2:
			if (index >= 1280 && !camcorder_check_flag)
				err = isx005_i2c_write(sd, isx005_1280x960_Zoom_02, sizeof(isx005_1280x960_Zoom_02) / sizeof(isx005_1280x960_Zoom_02[0]), "isx005_1280x960_Zoom_02");
			else
				err = isx005_i2c_write(sd, isx005_640x480_Zoom_02, sizeof(isx005_640x480_Zoom_02) / sizeof(isx005_640x480_Zoom_02[0]), "isx005_640x480_Zoom_02");
			break;
		case 3:
			if (index >= 1280 && !camcorder_check_flag)
				err = isx005_i2c_write(sd, isx005_1280x960_Zoom_03, sizeof(isx005_1280x960_Zoom_03) / sizeof(isx005_1280x960_Zoom_03[0]), "isx005_1280x960_Zoom_03");
			else
				err = isx005_i2c_write(sd, isx005_640x480_Zoom_03, sizeof(isx005_640x480_Zoom_03) / sizeof(isx005_640x480_Zoom_03[0]), "isx005_640x480_Zoom_03");
			break;
		case 4:
			if (index >= 1280 && !camcorder_check_flag)
				err = isx005_i2c_write(sd, isx005_1280x960_Zoom_04, sizeof(isx005_1280x960_Zoom_04) / sizeof(isx005_1280x960_Zoom_04[0]), "isx005_1280x960_Zoom_04");
			else
				err = isx005_i2c_write(sd, isx005_640x480_Zoom_04, sizeof(isx005_640x480_Zoom_04) / sizeof(isx005_640x480_Zoom_04[0]), "isx005_640x480_Zoom_04");
			break;
		case 5:
			if (index >= 1280 && !camcorder_check_flag)
				err = isx005_i2c_write(sd, isx005_1280x960_Zoom_05, sizeof(isx005_1280x960_Zoom_05) / sizeof(isx005_1280x960_Zoom_05[0]), "isx005_1280x960_Zoom_05");
			else
				err = isx005_i2c_write(sd, isx005_640x480_Zoom_05, sizeof(isx005_640x480_Zoom_05) / sizeof(isx005_640x480_Zoom_05[0]), "isx005_640x480_Zoom_05");
			break;
		case 6:
			if (index >= 1280 && !camcorder_check_flag)
				err = isx005_i2c_write(sd, isx005_1280x960_Zoom_06, sizeof(isx005_1280x960_Zoom_06) / sizeof(isx005_1280x960_Zoom_06[0]), "isx005_1280x960_Zoom_06");
			else
				err = isx005_i2c_write(sd, isx005_640x480_Zoom_06, sizeof(isx005_640x480_Zoom_06) / sizeof(isx005_640x480_Zoom_06[0]), "isx005_640x480_Zoom_06");
			break;
		case 7:
			if (index >= 1280 && !camcorder_check_flag)
				err = isx005_i2c_write(sd, isx005_1280x960_Zoom_07, sizeof(isx005_1280x960_Zoom_07) / sizeof(isx005_1280x960_Zoom_07[0]), "isx005_1280x960_Zoom_07");
			else
				err = isx005_i2c_write(sd, isx005_640x480_Zoom_07, sizeof(isx005_640x480_Zoom_07) / sizeof(isx005_640x480_Zoom_07[0]), "isx005_640x480_Zoom_07");
			break;
		case 8:
			if (index >= 1280 && !camcorder_check_flag)
				err = isx005_i2c_write(sd, isx005_1280x960_Zoom_08, sizeof(isx005_1280x960_Zoom_08) / sizeof(isx005_1280x960_Zoom_08[0]), "isx005_1280x960_Zoom_08");
			else
				err = isx005_i2c_write(sd, isx005_640x480_Zoom_08, sizeof(isx005_640x480_Zoom_08) / sizeof(isx005_640x480_Zoom_08[0]), "isx005_640x480_Zoom_08");
			break;
		default:
...
static int isx005_set_capture_size(struct v4l2_subdev *sd)
{
	...
	if(state->framesize_index > ISX005_CAPTURE_1MP && state->dzoom) {
		index = ISX005_CAPTURE_1MP;
		isx005_msg(&client->dev, "isx005_set_capture_size : index=%d, dzoom=%d\n", index, state->dzoom);
	}
	...
	switch(index)	{
		...
		case ISX005_CAPTURE_1MP: /* 1280x960 */
			err = isx005_i2c_write_multi(client, 0x0386, 0x0140, 2);// HSIZE_TN - 320
...
static int isx005_set_sensor_mode(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	...
	if (camcorder_check_flag == ctrl->value)
		return 0;
	...
	if (ctrl->value == 1) {
		...
		err = isx005_i2c_write(sd, \
			isx005_camcorder_off, \
			sizeof(isx005_camcorder_off) / sizeof(isx005_camcorder_off[0]), \
			"isx005_camcorder_off");
		if (err < 0) {
			dev_err(&client->dev, "%s: failed: i2c_write for set_sensor_mode %d\n", __func__, ctrl->value);
			return -EIO;
	...
	camcorder_check_flag = ctrl->value;
...
static int isx005_set_focus_mode(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	...
	// FF Camera
	dev_err(&client->dev, "%s: Not support set focus mode\n", __func__);
	return 0;
...
static int isx005_s_ctrl(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	...
	switch (ctrl->id) {
		...
		case V4L2_CID_CAMERA_SENSOR_MODE:
			...
			isx005_msg(&client->dev,"sensor mode = %d \n", ctrl->value);
			break;
		...
		default:
			dev_err(&client->dev, "%s: unknown set ctrl id %d\n",
						__func__, ctrl->id - V4L2_CID_PRIVATE_BASE);
			//err = -ENOIOCTLCMD;
			err = 0;
			break;
