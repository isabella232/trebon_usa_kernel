/***********************************************************************
* Driver for SR030PC30 (VGA Camera) from SILICONFILE
*
...
#include "sr030pc30_trebon.h"
#define CONFIG_LOAD_FILE_NAME "/sdcard/sr030pc30_tikal.h"
...
#define SR030PC30_DEBUG

#ifdef SR030PC30_DEBUG
...
* FUNCTION DECLARE
***************************************************************************/
static int sr030pc30_i2c_read_byte(struct i2c_client *client,
                                     unsigned short subaddr,
                                     unsigned short *data);

static int sr030pc30_i2c_write_byte(struct i2c_client *client,
                                     unsigned short subaddr,
                                     unsigned short data);

static int sr030pc30_i2c_read_word(struct i2c_client *client,
                                     unsigned short subaddr,
                                     unsigned short *data);

static int sr030pc30_i2c_write_word(struct i2c_client *client,
                                     unsigned short subaddr,
                                     unsigned short data);

static int sr030pc30_i2c_set_data_burst(struct i2c_client *client,
                                         regs_short_t reg_buffer[],
          				                 int num_of_regs);

static int sr030pc30_i2c_set_config_register(struct i2c_client *client,
                                         regs_short_t reg_buffer[],
          				                 int num_of_regs,
          				                 char *name);

static int sr030pc30_check_dataline_onoff(struct v4l2_subdev *sd, int onoff);
static int sr030pc30_get_iso_speed_rate(struct v4l2_subdev *sd);
...
static bool sr030pc30_regs_get_line(char *line_buf)
{
    int i;
    char *r_n_ptr = NULL;
...
static bool sr030pc30_regs_trim(char *line_buf)
{
    int left_index;
    int buff_len;
    int i;
...
static int sr030pc30_regs_parse_table(void)
{
    ...
    while(sr030pc30_regs_get_line(front_current_line))
    {
        if(sr030pc30_regs_trim(front_current_line) == false)
        {
            continue;
        }
...
static int sr030pc30_regs_table_write(struct i2c_client *client, char *name)
{
    ...
    if(bFound_table)
    {
        front_reg_num_of_element = sr030pc30_regs_parse_table();
    }
    else
    {
    ...
    err = sr030pc30_i2c_set_data_burst(client, front_reg_table, front_reg_num_of_element);
	if(err < 0)
	{
		CAM_ERROR_MSG(&client->dev, "[%s : %d] ERROR! sr030pc30_i2c_set_data_burst failed\n", __FILE__, __LINE__);
		return -EIO;
	}
...
int sr030pc30_regs_table_init(void)
{
	...
	filp = filp_open(CONFIG_LOAD_FILE_NAME, O_RDONLY, 0);
	...
	*((front_regs_buf_ptr + l) - 1) = '\0';
	...
	CAM_PRINTK("sr030pc30_reg_table_init\n");
...
***************************************************************************/
/**************************************************************************
 * sr030pc30_i2c_read_byte: Read (I2C) multiple bytes to the camera sensor
...
/**************************************************************************
 * sr030pc30_i2c_write_byte: Write (I2C) multiple bytes to the camera sensor
 * @client: pointer to i2c_client
...
/**************************************************************************
 * sr030pc30_i2c_read_word: Read (I2C) multiple bytes to the camera sensor
 * @client: pointer to i2c_client
 * @subaddr: data to be written
 * @*data: buffer where data is read
 *
...
/**************************************************************************
 * sr030pc30_i2c_write_word: Write (I2C) multiple bytes to the camera sensor
 * @client: pointer to i2c_client
 * @subaddr: register address
 * @data: data to be written
 *
...
/**************************************************************************
 * sr030pc30_i2c_set_data_burst: Write (I2C) multiple bytes to the camera sensor
 * @client: pointer to i2c_client
          				                 ...
          				                 int num_of_regs)
{
    ...
    for(i = 0; i < num_of_regs; i++)
    {
        ...
        switch(subaddr)
        {
            ...
            default:
            {
                err = sr030pc30_i2c_write_byte(client, subaddr, data_value);
            	if(err < 0)
            	{
...
/**************************************************************************
 * sr030pc30_i2c_set_config_register: Write (I2C) multiple bytes to the camera sensor
 * @client: pointer to i2c_client
 * @reg_buffer: buffer which includes all registers to be written.
 * @num_of_regs: number of registers to be written.
 * @name : This will be used for tuning.
...
#else
    	err = sr030pc30_i2c_set_data_burst(client, reg_buffer, num_of_regs);
#endif // FRONT_CONFIG_LOAD_FILE
...
static int sr030pc30_set_frame_rate(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	...
	switch(ctrl->value)
	{
		...
		{
			err = sr030pc30_i2c_set_config_register(client,
			                                  front_fps_auto_regs,
...
/**************************************************************************
 * sr030pc30_set_preview_stop
 *
 * Returns 0 on success, <0 on error
 ***************************************************************************/
static int sr030pc30_set_preview_stop(struct v4l2_subdev *sd)
{
	struct i2c_client *client = v4l2_get_subdevdata(sd);
 ...
 * Returns 0 on success, <0 on error
 ***************************************************************************/
static int sr030pc30_set_dzoom(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	struct i2c_client *client = v4l2_get_subdevdata(sd);
...
static int sr030pc30_set_preview_start(struct v4l2_subdev *sd)
{
	...
	{
        err = sr030pc30_check_dataline_onoff(sd, 1);
...
static int sr030pc30_set_capture_start(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	struct i2c_client *client = v4l2_get_subdevdata(sd);
	int err = 0;
	...
	front_gISOSpeedRating = sr030pc30_get_iso_speed_rate(sd);
	front_gExposureTime = sr030pc30_get_shutterspeed(sd);

	return 0;
}

static int sr030pc30_set_scene_mode(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	struct i2c_client *client = v4l2_get_subdevdata(sd);
...
static int sr030pc30_set_white_balance(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	struct i2c_client *client = v4l2_get_subdevdata(sd);
	int err = 0;
...
static int sr030pc30_set_metering(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	struct i2c_client *client = v4l2_get_subdevdata(sd);
...
static int sr030pc30_set_iso(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	struct i2c_client *client = v4l2_get_subdevdata(sd);
...
static int sr030pc30_set_ev(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	struct i2c_client *client = v4l2_get_subdevdata(sd);
	//struct sensor_state *state = to_state(sd); fix prevent issue pritesh
	int err = 0;
...
static int sr030pc30_set_saturation(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	struct i2c_client *client = v4l2_get_subdevdata(sd);
...
static int sr030pc30_set_contrast(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	struct i2c_client *client = v4l2_get_subdevdata(sd);
...
static int sr030pc30_set_sharpness(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	struct i2c_client *client = v4l2_get_subdevdata(sd);
...
static int sr030pc30_set_focus_mode(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	struct i2c_client *client = v4l2_get_subdevdata(sd);
...
static int sr030pc30_get_iso_speed_rate(struct v4l2_subdev *sd)
{
    ...
    sr030pc30_i2c_write_word(client, 0xFCFC, 0xD000);
    sr030pc30_i2c_write_word(client, 0x002C, 0x7000);
    sr030pc30_i2c_write_word(client, 0x002E, 0x2A18);
    sr030pc30_i2c_read_word(client, 0x0F12, &read_value);
...
static int sr030pc30_get_shutterspeed(struct v4l2_subdev *sd)
{
    ...
    sr030pc30_i2c_write_byte(client, 0x03, 0x20);   // Page mode : 0x20
    sr030pc30_i2c_read_byte(client, 0x80, &read_value1);
    sr030pc30_i2c_read_byte(client, 0x81, &read_value2);
    sr030pc30_i2c_read_byte(client, 0x82, &read_value3);

    ShutterSpeed = ((read_value1 << 19) + (read_value2 << 11) + (read_value3 << 3)) / 12;   // 24Mhz
...
#if 0
/* Sample code */
static const char *sr030pc30_querymenu_wb_preset[] = {
...
static struct v4l2_queryctrl sr030pc30_controls[] =
{
	...
	/* Sample code */
	{
		...
		.minimum = 0,
		.maximum = ARRAY_SIZE(sr030pc30_querymenu_wb_preset) - 2,
		.step = 1,
		.default_value = 0,
	},
#endif
...
const char **sr030pc30_ctrl_get_menu(u32 id)
{
	switch (id)
	{
		...
		case V4L2_CID_WHITE_BALANCE_PRESET:
			return sr030pc30_querymenu_wb_preset;
#endif
		default:
...
static int sr030pc30_queryctrl(struct v4l2_subdev *sd, struct v4l2_queryctrl *qc)
{
	...
	for (i = 0; i < ARRAY_SIZE(sr030pc30_controls); i++)
	{
		...
		{
			memcpy(qc, &sr030pc30_controls[i], sizeof(struct v4l2_queryctrl));
			return 0;
		}
	}
...
static int sr030pc30_enum_framesizes(struct v4l2_subdev *sd, struct v4l2_frmsizeenum *fsize)
{
	struct sensor_state *state = to_state(sd);
...
static int sr030pc30_enum_frameintervals(struct v4l2_subdev *sd, struct v4l2_frmivalenum *fival)
{
	return 0;
}
...
static int sr030pc30_g_ctrl(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	...
	switch (ctrl->id)
	{
		...
		default:
		{
			CAM_ERROR_MSG(&client->dev, "[%s] ERROR! not support g_ctrl(%d)\n",
					__func__, ctrl->id);
			err = 0; // set default value to sucees instead of -ENOTSUPP;
			break;
		}
	}
...
static int sr030pc30_s_ctrl(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	...
	switch(ctrl->id)
	{
		...
		{
			err = sr030pc30_set_ev(sd, ctrl);
			break;
		}

		case V4L2_CID_CAMERA_WHITE_BALANCE:
		{
			err = sr030pc30_set_white_balance(sd, ctrl);
			break;
		}
		...
		{
			err = sr030pc30_set_iso(sd, ctrl);
			break;
		}

		case V4L2_CID_CAMERA_METERING:
		{
			err = sr030pc30_set_metering(sd, ctrl);
			break;
		}

		case V4L2_CID_CAMERA_CONTRAST:
		{
			err = sr030pc30_set_contrast(sd, ctrl);
			break;
        }

		case V4L2_CID_CAMERA_SATURATION:
		{
			err = sr030pc30_set_saturation(sd, ctrl);
			break;
        }

		case V4L2_CID_CAMERA_SHARPNESS:
		{
			err = sr030pc30_set_sharpness(sd, ctrl);
			break;
        }
		...
		{
			err = sr030pc30_set_focus_mode(sd, ctrl);
			break;
        }
		...
		{
			err = sr030pc30_set_scene_mode(sd, ctrl);
			break;
        }

		case V4L2_CID_CAMERA_ZOOM:
		{
			err = sr030pc30_set_dzoom(sd, ctrl);
			break;
        }
		...
		{
			err = sr030pc30_set_capture_start(sd, ctrl);
			break;
		}
		...
		case V4L2_CID_CAM_PREVIEW_ONOFF:
		{
			...
			{
				err = sr030pc30_set_preview_stop(sd);
            		}
			break;
        	}
		...
		{
			err = sr030pc30_check_dataline_onoff(sd, 0);
			break;
        	}
		...
		case V4L2_CID_CAMERA_CAF_START_STOP:
		{
	        ...
	        default:
        	{
			CAM_ERROR_MSG(&client->dev, "[%s] ERROR! control %d failed\n",
...
static int sr030pc30_init(struct v4l2_subdev *sd, u32 val)
{
...
#ifdef FRONT_CONFIG_LOAD_FILE
	err = sr030pc30_regs_table_init();
	if(err < 0)
	{
		CAM_ERROR_MSG(&client->dev, "%s: sr030pc30_regs_table_init failed\n", __func__);
		return -ENOIOCTLCMD;
	}
#endif // FRONT_CONFIG_LOAD_FILE
	...
	{
		if(state->check_dataline == CHK_DATALINE_OFF)
		{
			err = sr030pc30_i2c_set_config_register(client,
        	                                  front_init_regs,
        	                                  INIT_NUM_OF_REGS,
 ...
 ***************************************************************************/
static int sr030pc30_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	struct sensor_state *state;
	struct v4l2_subdev *sd;

	CAM_INFO_MSG(&client->dev, "sr030pc30_probe.......................... \n");
	...
	CAM_ERROR_MSG(&client->dev, "VGA camera sr030pc30 loaded.\n");
...
static int sr030pc30_remove(struct i2c_client *client)
{
	...
	CAM_INFO_MSG(&client->dev, "sr030pc30_remove................. \n");
	...
	CAM_ERROR_MSG(&client->dev, "Unloaded camera sensor sr030pc30.\n");
...
MODULE_DESCRIPTION("SYSTEM LSI SR030PC10 VGA camera driver");
