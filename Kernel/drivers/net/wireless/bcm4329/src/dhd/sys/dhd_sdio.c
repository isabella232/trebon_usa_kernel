...
//OOB interrupt timeout is happened - to avoid the crash this debug statements are removed. 
//reinitiliziation of the driver module will be performed in case of OOB timeout.
#if 0//def DHD_DEBUG
		dhd_os_sdlock(bus->dhd);
