...
static unsigned int gIgnoreReport_flag = 0;
static unsigned int gForceCalibration_flag = 0;
...
void qt_Acquisition_Config_Init(void)
{
	if (info_block->info_id.family_id == 0x80) {
		...
		acquisition_config_e.atchcalst = 4;
		acquisition_config_e.atchcalsthr = 35;
		acquisition_config_e.atchfrccalthr = 40;
		acquisition_config_e.atchfrccalratio = 55;
...
void qt_Multitouchscreen_Init(void)
{
	if (info_block->info_id.family_id == 0x80) {
		...
		touchscreen_config_e.ctrl = 143; // 0
		...
		touchscreen_config_e.movhysti = 3;
		touchscreen_config_e.movhystn = 1; 
#ifdef CONFIG_TIKAL_MPCS
		touchscreen_config_e.movfilter = 47;
#else
		...
		touchscreen_config_e.nexttchdi = 2;//0;//2;
...
*
* ***************************************************************************/
void write_noise_suppression_config_e_TA(void)
{
	/* for TA setting */
	noise_suppression_config_e_TA.ctrl = 3;//1;//0
	noise_suppression_config_e_TA.cfg = 132;// 1
	noise_suppression_config_e_TA.calcfg = 82;//80;// 2
	noise_suppression_config_e_TA.basefreq = 0;// 3
	noise_suppression_config_e_TA.reserved1[0] = 0; // 4

	noise_suppression_config_e_TA.reserved1[1] = 0;// 5
	noise_suppression_config_e_TA.reserved1[2] = 0;// 6
	noise_suppression_config_e_TA.reserved1[3] = 0;// 7
	noise_suppression_config_e_TA.mffreq[0] = 10;//0;// 8
	noise_suppression_config_e_TA.mffreq[1] = 20;//0;// 9

	noise_suppression_config_e_TA.reserved2[0] = 0;// 10
	noise_suppression_config_e_TA.reserved2[1] = 0;// 11
	noise_suppression_config_e_TA.reserved2[2] = 0;// 12
	noise_suppression_config_e_TA.gcactvinvldadcs = 6;// 13
	noise_suppression_config_e_TA.gcidlenivldadcs = 6;// 14

	noise_suppression_config_e_TA.reserved3[0] = 0;// 15
	noise_suppression_config_e_TA.reserved3[1] = 0;//
	noise_suppression_config_e_TA.gcmaxadcsperx = 64;//100;//
	noise_suppression_config_e_TA.gclimitmin = 4;//
	noise_suppression_config_e_TA.gclimitmax = 64;//

	noise_suppression_config_e_TA.gccountmintgt = 10;// 20_21
	noise_suppression_config_e_TA.mfinvlddiffthr = 9;//10;//12;//20;//
	noise_suppression_config_e_TA.mfincadcspxthr = 5;//

	noise_suppression_config_e_TA.mferrorthr = 15;//19;//38;//25
	...
	noise_suppression_config_e_TA.reserved4[2] = 0;//30
	...
	noise_suppression_config_e_TA.blen = 0;//

	noise_suppression_config_e_TA.tchthr = 40;//35
	noise_suppression_config_e_TA.tchdi = 2;//
	noise_suppression_config_e_TA.movhysti = 5;//
	noise_suppression_config_e_TA.movhystn = 2;// 
	noise_suppression_config_e_TA.movfilter = 47;//46;

	noise_suppression_config_e_TA.numtouch = 10;//40
	noise_suppression_config_e_TA.mrghyst = 5;//
	noise_suppression_config_e_TA.mrgthr = 40;// 
	noise_suppression_config_e_TA.xloclip = 10;// 
	noise_suppression_config_e_TA.xhiclip = 0;// 

	noise_suppression_config_e_TA.yloclip = 10;// 45
	...
	noise_suppression_config_e_TA.yedgedist = 80;// 50
	noise_suppression_config_e_TA.jumplimit = 18;//
	noise_suppression_config_e_TA.tchhyst = 15;// 
	noise_suppression_config_e_TA.nexttchdi = 0;//2;//
}
...
void qt_Noise_Suppression_Config_Init(void)
{
	...
	if (info_block->info_id.family_id == 0x80) {
		...
		noise_suppression_config_e.ctrl = 15;//1;//0
#else
		noise_suppression_config_e.ctrl = 3;//1;//0
#endif
		noise_suppression_config_e.cfg = 132;// 1
		noise_suppression_config_e.calcfg = 64;// 2
		noise_suppression_config_e.basefreq = 0;// 3
		noise_suppression_config_e.reserved1[0] = 0; // 4

		noise_suppression_config_e.reserved1[1] = 0;// 5
		noise_suppression_config_e.reserved1[2] = 0;// 6
		noise_suppression_config_e.reserved1[3] = 0;// 7
		noise_suppression_config_e.mffreq[0] = 10;//0;// 8
		noise_suppression_config_e.mffreq[1] = 20;//0;// 9

		noise_suppression_config_e.reserved2[0] = 0;// 10
		noise_suppression_config_e.reserved2[1] = 0;// 11
		noise_suppression_config_e.reserved2[2] = 0;// 12
		noise_suppression_config_e.gcactvinvldadcs = 6;// 13
		noise_suppression_config_e.gcidlenivldadcs = 6;// 14

		noise_suppression_config_e.reserved3[0] = 0;// 15
		noise_suppression_config_e.reserved3[1] = 0;//
		noise_suppression_config_e.gcmaxadcsperx = 48;//100;//
		noise_suppression_config_e.gclimitmin = 4;//
		noise_suppression_config_e.gclimitmax = 48;//64;//

		noise_suppression_config_e.gccountmintgt = 10;// 20~21
#if defined(CONFIG_TIKAL_USCC) || defined(CONFIG_TIKAL_MPCS)
		noise_suppression_config_e.mfinvlddiffthr = 9;//
#else
		noise_suppression_config_e.mfinvlddiffthr = 10;//
#endif
		noise_suppression_config_e.mfincadcspxthr = 5;//
		noise_suppression_config_e.mfincadcspxthr = 0;//		
#if defined(CONFIG_TIKAL_USCC) || defined(CONFIG_TIKAL_MPCS)
		noise_suppression_config_e.mferrorthr = 15;//25
		noise_suppression_config_e.selfreqmax = 1;//
#else
		noise_suppression_config_e.mferrorthr = 20;//25
		noise_suppression_config_e.selfreqmax = 5;//
#endif
		noise_suppression_config_e.reserved4[0] = 0;// 
		noise_suppression_config_e.reserved4[1] = 0;//
		
		noise_suppression_config_e.reserved4[2] = 0;//30
		noise_suppression_config_e.reserved4[3] = 0;//
		noise_suppression_config_e.reserved4[4] = 0;//
		noise_suppression_config_e.reserved4[5] = 0;// 
		noise_suppression_config_e.blen = 32;//
		
		noise_suppression_config_e.tchthr = 50;//35
		noise_suppression_config_e.tchdi = 2;//
		noise_suppression_config_e.movhysti = 3;//
		noise_suppression_config_e.movhystn = 1;// 
		noise_suppression_config_e.movfilter = 46;//

		noise_suppression_config_e.numtouch = 10;//40
		...
		noise_suppression_config_e.yloclip = 10;// 45
		...
		noise_suppression_config_e.yedgedist = 80;// 50
		noise_suppression_config_e.jumplimit = 18;//
		noise_suppression_config_e.tchhyst = 15;// 
		noise_suppression_config_e.nexttchdi = 0;//2;//
		...
		write_noise_suppression_config_e_TA();
...
#if 0 //eplus andy add 20111019
void qt_SptUserdata_Init(void)
{
	//static u8 t38_config_e[] = {SPT_USERDATA_T38, 0, 1, 12, 19, 38, 0, 0, 0};//110927 gumi noise

	spt_userdata_config_e.data[0]=0;
	spt_userdata_config_e.data[1]=1;
	spt_userdata_config_e.data[2]=12;
	spt_userdata_config_e.data[3]=19;
	spt_userdata_config_e.data[4]=38;
	spt_userdata_config_e.data[5]=40;
	spt_userdata_config_e.data[6]=80;
	spt_userdata_config_e.data[7]=0;

	if (get_object_address(SPT_USERDATA_T38, 0) != OBJECT_NOT_FOUND) {
		if (write_userdata_config(0,spt_userdata_config_e) != CFG_WRITE_OK)
			dprintk("[TSP] Configuration Fail!!! , Line %d \n\r", __LINE__);
	}
...
void qt_CTE_Config_Init(void)
{
	if (info_block->info_id.family_id == 0x80) {
		...
		cte_config_e.actvsyncsperx = 46;//40;//32;//32;//48;
...
void qt_Touch_Suppression_Config_Init(void)
{
	if (info_block->info_id.family_id == 0x80) {
		...
		touch_suppression_config.ctrl = 0;
		touch_suppression_config.apprthr = 0;//32;
		touch_suppression_config.maxapprarea = 0;//120;
		touch_suppression_config.maxtcharea = 0;//100;
		touch_suppression_config.supstrength = 0;
		touch_suppression_config.supextto = 0;
		touch_suppression_config.maxnumtchs = 0;
		touch_suppression_config.shapestrength = 0;
...
uint8_t calibrate_chip(void)
{
	...
	uint8_t atchcalst, atchcalsthr,atchfrccalthr,atchfrccalratio;
	...
	if (info_block->info_id.family_id == 0x80) {
		...
		if (cal_check_flag == 0) {
			...
			atchfrccalthr = acquisition_config_e.atchfrccalthr;
			atchfrccalratio = acquisition_config_e.atchfrccalratio;
			...
			write_mem(object_address+6, 1, &acquisition_config_e.atchcalst);
			write_mem(object_address+7, 1, &acquisition_config_e.atchcalsthr);
			write_mem(object_address+8, 1, &acquisition_config_e.atchfrccalthr);
			write_mem(object_address+9, 1, &acquisition_config_e.atchfrccalratio);
			...
			acquisition_config_e.atchfrccalthr = atchfrccalthr;
			acquisition_config_e.atchfrccalratio = atchfrccalratio;
		}
	}

	/* send calibration command to the chip */
	if ((ret == WRITE_MEM_OK) && (!Doing_calibration_falg)) {
	/* change calibration suspend settings to zero until calibration confirmed good */
	...
	gForceCalibration_flag = 1; //20120228
	return ret;
}
...
*
* ***************************************************************************/
uint8_t write_userdata_config(uint8_t instance, debug_diagnositc_t38_userdata_t cfg)
{
	uint16_t object_address;
	uint8_t *tmp;
	uint8_t status;
	...
	*(tmp + 8) = cfg.data[8];
	...
	object_address = get_object_address(SPT_USERDATA_T38, instance);
	if (object_address == 0) {
		kfree(tmp);
		return(CFG_WRITE_FAILED);
	}
...
void quantum_touch_probe(void)
{
	...
	if (info_block->info_id.family_id == 0x80) {
		...
		qt_Power_Config_Init();  //T7
		qt_Acquisition_Config_Init(); //T8
		qt_Multitouchscreen_Init(); //T9
		qt_KeyArray_Init(); //T15
		qt_ComcConfig_Init(); //T18
		qt_Proximity_Config_Init();//T23
		qt_Selftest_Init();//T25
#if 0 // eplus andy add 20111019		
		qt_SptUserdata_Init();// T38
#endif
		qt_Grip_Suppression_Config_Init();//T40
		qt_Touch_Suppression_Config_Init();//T42
		qt_CTE_Config_Init();//T46
		qt_Stylus_Init();//T47
		qt_Noise_Suppression_Config_Init();//T48
    } else
	...
	noise_median.t48_movfilter_for_mferr = 80;
#endif	
}
...
static bool TA_inserted_suspend = 0;
#endif
//20100217 julia
			...
			if (qt_timer_state == 1) {
				...
				{ //jun change 11.5.3
					...
					if (info_block->info_id.family_id == 0x80) {
						...
						write_mem(object_address+4, 1, &data_byte); /* TCHAUTOCAL disable */	
...
#if defined(USE_TS_TA_DETECT_CHANGE_REG) && (defined(CONFIG_TIKAL_USCC) || defined(CONFIG_TIKAL_MPCS))
						if (!touch_TA_detect) {
							object_address = get_object_address(PROCG_NOISESUPPRESSION_T48, 0);
							data_byte = 5;
							write_mem(object_address+27, 1, &data_byte);
						}
#endif
#else
						if (write_acquisition_config_e(acquisition_config_e) != CFG_WRITE_OK) {
...
void NoiseEntryStartFunc(void)
{
	...
	if (gResume_flag == 1){ //20120229
		...
		printk(KERN_DEBUG"[TSP] Noise Start Flag In t(90) di(3)\n");
	} else {
		/* Threshold */
		data = touchscreen_config_e.tchthr; //50;
		status = write_mem(object_address+7, 1, &data);
		...
		if (touch_TA_detect == 0) {
			...
			data =5;
			status = write_mem(object_address+27, 1, &data);
		}
		printk(KERN_DEBUG"[TSP] Noise Start Flag Out t(default) di(default)\n");
	}
}
...
static int set_tsp_threshhold(bool state)
{
	...
	if (info_block->info_id.family_id == 0x80) {
		...
		if (state) {
			data = 22;
			status = write_mem(object_address+0, 1, &data);
		...
		{
			// Blen
			data = touchscreen_config_e.blen; //32;
			status = write_mem(object_address+6, 1, &data);
#if defined(CONFIG_TIKAL_USCC) || defined(CONFIG_TIKAL_MPCS)
			NoiseEntryStartFunc();
#else
			// Touch Threshold
...
#endif
			// MoveFilter
			data = touchscreen_config_e.movfilter; //46;
			status = write_mem(object_address+13, 1, &data);

			// Next DI
		        data = touchscreen_config_e.nexttchdi;
		        status = write_mem(object_address+34, 1, &data);
		}

		object_address = get_object_address(SPT_CTECONFIG_T46, 0);
		if (object_address == OBJECT_NOT_FOUND) {
			dprintk("\n[TSP][ERROR] SPT_CTECONFIG_T46 object_address : %d\n", __LINE__);
			return -1;
		}
        
		data = cte_config_e.actvsyncsperx;
		status = write_mem(object_address+3, 1, &data);
		...
		if (state) {
			write_noise_suppression_config_e_TA();			
			data = noise_suppression_config_e_TA.calcfg;
			status = write_mem(object_address+2, 1, &data);
...
int set_tsp_for_ta_detect(int state)
{
	...
	if (info_block->info_id.family_id == 0x80) {
		...
		if (state) {
			touchscreen_config_e.nexttchdi = 0;
                    cte_config_e.actvsyncsperx = 32;
			
		} else {
			touchscreen_config_e.nexttchdi = 2;
			cte_config_e.actvsyncsperx = 46;//40;// 32;
		}	
       }
...
static void mxt224_optical_gain(uint16_t dbg_mode)
{
	...
	u8 data_buffer[2] = { 0 };
	u8 node = 0;
	int reference_over = 0;
	u16 size_one;
	u8 val = 0, dualXon_flag=0;
	unsigned int register_address = 2;

	printk(KERN_ERR "[TSP] +mxt224_optical_gain()\n");

	object_address = get_object_address(PROCG_NOISESUPPRESSION_T48, 0);
	size_one = 1;
	read_mem(object_address+(u16)register_address, (u8)size_one, &val);
	if((val&0x10) != 0x10)
	{
		dualXon_flag=1;
		val=val|0x10;
		write_mem(object_address+(u16)register_address, size_one, &val);
	}
	...
	object_address = get_object_address(DEBUG_DIAGNOSTIC_T37, 0);
	...
	for (read_page = 0; read_page < 4; read_page++) {
		for (node = 0; node < 64; node++) {
			read_point = (node * 2) + 2;
			read_mem(object_address+(u16)read_point, 2, data_buffer);
	...
	if (reference_over){
		if(noise_suppression_config_e_TA.blen !=0){
			noise_suppression_config_e_TA.blen=noise_suppression_config_e_TA.blen -16;
			noise_suppression_config_e_TA.tchthr=40;
		}
	}
...
static void median_err_setting()
{
	u16 obj_address;
	u8 value, state;

	printk(KERN_DEBUG"[TSP] %s(ta:%d)\n", __func__, touch_TA_detect);
	...
	if(!touch_TA_detect)
	{
		...
		switch(gErrCondition)
		{
			...
			{
				obj_address = get_object_address(TOUCH_MULTITOUCHSCREEN_T9, 0);
				value = 16;
				write_mem(obj_address+6, 1, &value) ;
				
				value = 40;
				write_mem(obj_address+7, 1, &value) ;
				
				value = 80;
				write_mem(obj_address+13, 1, &value) ;

				obj_address = get_object_address(SPT_CTECONFIG_T46, 0);
				value = 32;
				write_mem(obj_address+3, 1, &value) ;

				obj_address = get_object_address(PROCG_NOISESUPPRESSION_T48, 0);
				value = 29;
				write_mem(obj_address+3, 1, &value) ;
				value = 1;
				write_mem(obj_address+8, 1, &value) ;
				value = 2;
				write_mem(obj_address+9, 1, &value) ;
				value = 100;
				write_mem(obj_address+17, 1, &value) ;
				value = 64;
				write_mem(obj_address+19, 1, &value) ;
				value = 20;
				write_mem(obj_address+22, 1, &value) ;
				value = 38;
				write_mem(obj_address+25, 1, &value) ;
				value = 16;
				write_mem(obj_address+34, 1, &value) ;
				value = 40;
				write_mem(obj_address+35, 1, &value) ;
				value = 80;
				write_mem(obj_address+39, 1, &value) ;
			}
			break;
		}	
	}
	else //TA mode 110927 gumi noise (TA)
	{
		value = 1;
		...
		if (!(noise_median.mferr_count%value)&&(noise_median.mferr_count < 3)) //3 
		{
		   ...
		   obj_address = get_object_address(PROCG_NOISESUPPRESSION_T48, 0);
    		   printk(KERN_ERR"[TSP]PROCG_NOISESUPPRESSION_T48 value is %d\n", obj_address);
		   ...
		   if(state == 1)
		   {
				...
				obj_address = get_object_address(PROCG_NOISESUPPRESSION_T48, 0);//20120229
		   		printk(KERN_ERR"[TSP]PROCG_NOISESUPPRESSION_T48 value is %d\n", obj_address);
				
		   		read_mem(obj_address+22, 1, &value); 
		   		printk(KERN_ERR"[TSP]mfinvlddiffthr value is %d\n", value);
		 	  	read_mem(obj_address+25, 1, &value); 
		   		printk(KERN_ERR"[TSP]mferrorthr value is %d\n",value);
				read_mem(obj_address+35, 1, &value); 
				printk(KERN_ERR"[TSP]t48_thr_for_mferr value is %d\n",value);				
				read_mem(obj_address+39, 1, &value); 
				printk(KERN_ERR"[TSP]t48_movfilter_for_mferr value is %d\n",value);

				obj_address = get_object_address(SPT_CTECONFIG_T46, 0);
		   		read_mem(obj_address+3, 1, &value); 		   
		   ...
		   else if(state >= 2)
		   {
				...
				obj_address = get_object_address(PROCG_NOISESUPPRESSION_T48, 0);//20120229
		   		...
		   		read_mem(obj_address+3, 1, &value); 
				printk(KERN_ERR"[TSP]basefreq value is %d\n", value);				
		   		read_mem(obj_address+8, 1, &value); 
				printk(KERN_ERR"[TSP]secondmf value is %d\n", value);
		   		read_mem(obj_address+9, 1, &value); 
				printk(KERN_ERR"[TSP]thirdmf value is %d\n", value);
		   		read_mem(obj_address+22, 1, &value); 
				printk(KERN_ERR"[TSP]mfinvlddiffthr value is %d\n", value);
		   		read_mem(obj_address+25, 1, &value); 
				printk(KERN_ERR"[TSP]mferrorthr value is %d\n", value);
		   		read_mem(obj_address+35, 1, &value); 
				printk(KERN_ERR"[TSP]thr value is %d\n", value);				
		   		read_mem(obj_address+39, 1, &value); 
				printk(KERN_ERR"[TSP]movfilter value is %d\n", value);
...
//	printk("msg id=%x %x %x %x %x\n",quantum_msg[0],quantum_msg[1], quantum_msg[2]&0xF0,quantum_msg[3]&0xF,quantum_msg[4]);
		...
		*/
		...
		if (quantum_msg[0] == 1) {
			...
			if ((quantum_msg[1]&0x10) == 0x00)
			{
				...
				if (gForceCalibration_flag && (gIgnoreReport_flag ==1) ) {//20120229
					gIgnoreReport_flag = 0;
					printk("[TSP] Now! Enable Touch Report!!!  \n");
				}
			}
			...
			if ((quantum_msg[1]&0x10) == 0x10) {
				printk(KERN_DEBUG"[TSP] Calibration\n");
				Doing_calibration_falg = 1;
			}
			if ((quantum_msg[1]&0x20) == 0x20) {
			...
			if (error == 1) {
				printk(KERN_ERR"[TSP] error ENTER\n");
				/* force release */
				TSP_forced_release();
		...
		} else if ((quantum_msg[0] == 14)&&(info_block->info_id.family_id == 0x80)) {  /* Palm Touch */
			if ((quantum_msg[1]&0x01) == 0x01) {
		...
		else if (quantum_msg[0] == 0 ||(quantum_msg[0] > max_report_id &&quantum_msg[0]<255)){
			gpio_set_value(GPIO_TOUCH_EN, 0);
			msleep(1);
			gpio_set_value(GPIO_TOUCH_EN, 1);
			msleep(70);
			calibrate_chip();
			printk("Reset complite\n");
			return;
		}

		if (info_block->info_id.family_id == 0x81) {	/* MXT-224E */
			if ( quantum_msg[0] == 18) {
				if ((quantum_msg[4]&0x5) == 5) 
				{
					printk(KERN_ERR"[TSP] Median filter Error\n");
					median_err_setting();
				}
				else if ((quantum_msg[4]&0x4) == 4) 
				{
						if((!touch_TA_detect)&&(noise_median.mferr_setting == false)&&(noise_median.median_on_flag == false))
						{
							printk(KERN_ERR"[TSP] median filter ON!!!\n");
							// nextdi -> 0
							object_address = get_object_address(TOUCH_MULTITOUCHSCREEN_T9, 0);
							data = 0;
							write_mem(object_address+34, 1, &data) ;
		...
		if (((quantum_msg[0] == 14)&&(info_block->info_id.family_id == 0x80)) || (quantum_msg[0] == 0) || (quantum_msg[0] == 0xFF)) {
		...
		return ;
	} else if (gIgnoreReport_flag == 1) {//20120228
               ...
               const struct i2c_device_id *id)
{
	...
	qt602240->input_dev->name = "sec_touchscreen";
...
#ifdef FOR_LCD_FACTORYTEST
	qt602240->early_suspend.level = EARLY_SUSPEND_LEVEL_DISABLE_FB - 1;
#else
...
//	int i = 0;
	...
	if(touch_TA_detect==0){
		...
		gpio_set_value(TOUCHKEY_LED_EN, 0);		
		TA_inserted_suspend=0;
	}
	else
		TA_inserted_suspend=1;
#else
	/*reset the gpio's for the sleep configuration*/
	s3c_gpio_cfgpin(GPIO_TOUCH_INT, S3C_GPIO_INPUT);
	s3c_gpio_setpull(GPIO_TOUCH_INT, S3C_GPIO_PULL_DOWN);
...
#ifdef FOR_LCD_FACTORYTEST
	printk("max_report_id = %d\n", max_report_id);	

	max_report_id = 0;
	quantum_touch_probe(); // for factory test
#else
	noise_median.mferr_count=0;
	noise_median.mferr_setting = false;
	noise_median.median_on_flag = false;
...
static ssize_t object_write_store(struct device *dev,
					...
					const char *buf, size_t count)
{
	...
	address = get_object_address((u8)object_type, 0);
	size = get_object_size((u8)object_type);
...
static DEVICE_ATTR(object_write, 0664, NULL, object_write_store);
/*****************************************************************************
*
*  FUNCTION
*  PURPOSE
...
#define MIN_VALUE 4840
#define MAX_VALUE 13500
...
static ssize_t set_module_on_show(struct device *dev, struct device_attribute *attr, char *buf)
{
	...
	enable_irq(qt602240->client->irq);
#else
	if (touchscreen_power_state_on == 0) {
		gResume_flag = 1;
		gIgnoreReport_flag = 1;
		...
		printk(KERN_DEBUG"[TSP] touch already on.\n");
	}
#endif
...
static DEVICE_ATTR(disp_all_refdata, 0664, disp_all_refdata_show, disp_all_refdata_store);
static DEVICE_ATTR(set_all_delta, 0664, set_all_delta_mode_show, NULL);
static DEVICE_ATTR(disp_all_deltadata, 0664, disp_all_deltadata_show, disp_all_deltadata_store);
static DEVICE_ATTR(set_firm_version, 0664, set_firm_version_show, NULL);
static DEVICE_ATTR(set_module_off, 0664, set_module_off_show, NULL);
static DEVICE_ATTR(set_module_on, 0664, set_module_on_show, NULL);
static DEVICE_ATTR(mxt_touchtype, 0664, mxt_touchtype_show, NULL);
static DEVICE_ATTR(x_line, 0664, x_line_show, NULL);
static DEVICE_ATTR(y_line, 0664, y_line_show, NULL);
...
static ssize_t set_qt_firm_version_show(struct device *dev, struct device_attribute *attr, char *buf)
{
	...
	/* The below log is for watching the global variables and noise registers when the TSP lock up happens*/ //20120229
	u16 obj_address = 0;
	u8 value = 0;

	printk(KERN_ERR"[TSP]noise_median.t46_actvsyncsperx_for_mferr is %d\n", noise_median.t46_actvsyncsperx_for_mferr);		
	printk(KERN_ERR"[TSP]noise_median.t48_mfinvlddiffthr_for_mferr is %d\n", noise_median.t48_mfinvlddiffthr_for_mferr);		
	printk(KERN_ERR"[TSP]noise_median.t48_mferrorthr_for_mferris %d\n", noise_median.t48_mferrorthr_for_mferr);		
	printk(KERN_ERR"[TSP]noise_median.t48_thr_for_mferr is %d\n", noise_median.t48_thr_for_mferr);		
	printk(KERN_ERR"[TSP]noise_median.t48_movfilter_for_mferr is %d\n", noise_median.t48_movfilter_for_mferr);		
...
int __init qt602240_init(void)
{
	...
	if (device_create_file(qt602240_noise_test, &dev_attr_mxt_touchtype) < 0)
		printk("Failed to create device file(%s)!\n", dev_attr_mxt_touchtype.attr.name);
	if (device_create_file(qt602240_noise_test, &dev_attr_x_line) < 0)
		printk("Failed to create device file(%s)!\n", dev_attr_x_line.attr.name);
	if (device_create_file(qt602240_noise_test, &dev_attr_y_line) < 0)
