...
static void release_all_fingers(struct melfas_ts_data *ts)
{
	...
	input_report_key(ts->input_dev, 139, RELEASE_KEY);
	input_report_key(ts->input_dev, 102, RELEASE_KEY);
	input_report_key(ts->input_dev, 158, RELEASE_KEY);
	input_report_key(ts->input_dev, 217, RELEASE_KEY);
