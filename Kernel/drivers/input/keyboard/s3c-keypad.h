...
#elif defined (CONFIG_MACH_S5PC110_ARIES) || defined (CONFIG_MACH_STEALTHV)|| defined (CONFIG_MACH_AEGIS) || defined(CONFIG_MARCH_VIPER) || defined(CONFIG_TIKAL_MPCS)
...
//TREBON KEYPAD 
#elif defined(CONFIG_MACH_CHIEF) && defined(CONFIG_MACH_TREBON)
#define KEYPAD_COLUMNS      3
#define KEYPAD_ROWS         1
#define MAX_KEYPAD_NR       3
...
#err_4
#elif defined(CONFIG_MACH_CHIEF) && defined(CONFIG_MACH_TREBON)
		  L_VOL_UP, L_HOME, L_VOL_DOWN,

#elif defined (CONFIG_MACH_CHIEF) && !defined(CONFIG_TIKAL_MPCS) && !defined(CONFIG_MACH_TREBON)// TODO:CHIEF
...
#elif defined (CONFIG_MACH_STEALTHV) || defined(CONFIG_TIKAL_MPCS)
