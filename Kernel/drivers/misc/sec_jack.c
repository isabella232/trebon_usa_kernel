...
#include <linux/sec_jack.h>
        ...
        || (defined(CONFIG_TIKAL_MPCS) && (CONFIG_SEC_HW_VER >= 1))
#define CONFIG_STANDARD_EAR_JACK
#endif
...
#if defined(CONFIG_STANDARD_EAR_JACK)
#if defined(CONFIG_TIKAL_USCC)
        if (HWREV >= 0xE) // Tikal USCC : hw_rev 0.3
                npolarity = pdata->det_active_high;
#else
        npolarity = pdata->det_active_high;
#endif
#endif
