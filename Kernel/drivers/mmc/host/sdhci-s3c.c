...
static int sdhci_s3c_shutdown(struct platform_device *dev, pm_message_t pm)
{
...
#if defined(CONFIG_MACH_AEGIS) || defined(CONFIG_TIKAL_USCC)|| defined(CONFIG_MACH_CHIEF)
	if(pdata->set_power)
