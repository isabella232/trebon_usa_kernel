...
#elif  defined (CONFIG_FB_S3C_S6D05A3)
extern void s6d05a3_ldi_stand_by(void);
extern void s6d05a3_ldi_init(void);
extern void s6d05a3_ldi_disable(void);
extern void lcd_cfg_gpio_early_suspend(void);
extern void lcd_esd_irq_enable(void);
#endif
