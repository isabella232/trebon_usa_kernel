...
static unsigned int debug_timer_control;
static unsigned long debug_load_val;
static int debug_autoreset;
#endif
...
#if defined(CONFIG_MACH_CHIEF)
	debug_timer_control = 1;
	debug_load_val = load_val;
	debug_autoreset = autoreset;
#endif
