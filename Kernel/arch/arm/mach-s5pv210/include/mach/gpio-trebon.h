...
#define GPIO_DUMMY               GPIO_GPI6//GPIO_GPC14
...
#define GPIO_EAR_SEND_END        S5PV210_GPH0(2)
...
#define GPIO_CAM_FLASH_SET_NEW   S5PV210_GPJ0(5)

#define GPIO_TA_nCHG_REV01             S5PV210_GPJ0(3) 	/*Added for SMB charger*/
#define GPIO_TA_nCHG_REV02             S5PV210_GPH1(5) 	/*Added for SMB charger from Rev02, GPIO changed to EINT13*/

#define GPIO_CAM_VDD_REG_EN      S5PV210_GPJ0(6)
...
#define GPIO_CAM_VT_VDD_REG_EN   S5PV210_GPJ1(4)
...
#define GPIO_WLAN_EN    S5PV210_GPG1(2)
