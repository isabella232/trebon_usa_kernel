...
static unsigned int initial_gpio_table[][4] =
{
    ...
    {S5PV210_GPA0(5), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, /* KEY_SCAN(6) */
	...
	{S5PV210_GPA1(2), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
   ...
   {S5PV210_GPB(2),  S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	...
	{S5PV210_GPB(4),  S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPB(5),  S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPB(6),  S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPB(7),  S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 

	// GPC0 --------------------------------------------------------------------
	{S5PV210_GPC0(0), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN},
	{S5PV210_GPC0(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_UP}, 
	...
	{S5PV210_GPD0(3), S3C_GPIO_EINT,   S3C_GPIO_SETPIN_ONE,  S3C_GPIO_PULL_UP  }, 
	...
	{S5PV210_GPD1(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPD1(3), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPD1(4), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPD1(5), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
	...
	{S5PV210_GPG0(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
	...
	// GPG3 --------------------------------------------------------------------
	{S5PV210_GPG3(0), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPG3(1), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPG3(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
	...
	{S5PV210_GPG3(6), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_DOWN}, 

	// GPH0 --------------------------------------------------------------------
	{S5PV210_GPH0(0), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPH0(1), S3C_GPIO_EINT,   S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPH0(2), S3C_GPIO_EINT,   S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, 
	...
	{S5PV210_GPH1(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPH1(3), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPH1(4), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_UP  }, 
	{S5PV210_GPH1(5), S3C_GPIO_EINT,   S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPH1(6), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, 
	...
	{S5PV210_GPH2(2), S3C_GPIO_EINT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, 
	...
	{S5PV210_GPH2(6), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPH2(7), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_DOWN}, 

	// GPH3 --------------------------------------------------------------------
	{S5PV210_GPH3(0), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
	...
	{S5PV210_GPH3(7), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
	...
	{S5PV210_GPJ0(1), S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
    ...
    {S5PV210_MP01(1), S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, 
...
//	{S5PV210_MP01(7), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	...
	// MP02 --------------------------------------------------------------------
	{S5PV210_MP02(0), S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, 
...
//	{S5PV210_MP03(4), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, 
	...
	// MP04 --------------------------------------------------------------------
	{S5PV210_MP04(0), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, 
	...
	// MP05 --------------------------------------------------------------------
#if 1 // heatup - chief - add
   {S5PV210_MP05(0), S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
	{S5PV210_MP05(1), S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
...
static unsigned int sleep_gpio_table[][3] =
{
   ...
   /* GPA0 */
	{S5PV210_GPA0(0), S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},  /* BT_UART_RXD */
 	{S5PV210_GPA0(1), S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},  /* BT_UART_TXD */ // p9p9 2010.11.15
  	...
  	{S5PV210_GPA0(4), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},    /* ACC_INT */
	{S5PV210_GPA0(5), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},    /* KEY_SCAN(6) */ // TODO:YUNG_RECHECK
  	{S5PV210_GPA0(6), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* CAM_MEGA_EN */
  	{S5PV210_GPA0(7), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},    /* TA_CURRENT_SEL(CHG_DET) */

   /* GPA1 */
	{S5PV210_GPA1(0), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_DOWN},  /* AP_RXD */
  	{S5PV210_GPA1(1), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},  /* AP_TXD */
  	{S5PV210_GPA1(2), S3C_GPIO_SLP_OUT1,  S3C_GPIO_PULL_NONE},  /* CP_RST */
 //	{S5PV210_GPA1(3), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},    /* KEY_SCAN(7) */ // TODO:YUNG_RECHECK
   ...
   /* GPD0 */
	{S5PV210_GPD0(0), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* BOOT_MODE   */
   {S5PV210_GPD0(1), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},  /* VIBTONZ_PWM */
   {S5PV210_GPD0(2), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},    /* MSENSE_nRST */
   {S5PV210_GPD0(3), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* TS_INT HW PULL_UP */
   ...
   {S5PV210_GPE1(4), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},    /* CAM_RST */
   ...
   {S5PV210_GPF3(5), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},  /* LTE_WAKE_INT */ // TODO:LTE
#if 0
   /* GPG0 */
   ...
   {S5PV210_GPG0(1), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},   /* NAND_CMD HW PULL-UP */
   {S5PV210_GPG0(2), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},  /* AP_PMIC_SCL HW PULL-UP */
   {S5PV210_GPG0(3), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},   /* NAND_D(0) HW PULL-UP */
   {S5PV210_GPG0(4), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},   /* NAND_D(1) HW PULL-UP */
   {S5PV210_GPG0(5), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},   /* NAND_D(2) HW PULL-UP */
   {S5PV210_GPG0(6), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},   /* NAND_D(3) HW PULL-UP */
   /* GPG1 */
   {S5PV210_GPG1(0), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* WLAN_SDIO_CLK */
   {S5PV210_GPG1(1), S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE},  /* WLAN_SDIO_CMD HW PULL_UP */
   {S5PV210_GPG1(2), S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},  /* WLAN_nRST */ // 2010.11.25 Sleep current issue when only BT sleep state
   {S5PV210_GPG1(3), S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE},  /* WLAN_SDIO_D(0) HW PULL_UP */
   {S5PV210_GPG1(4), S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE},  /* WLAN_SDIO_D(1) HW PULL_UP */
   {S5PV210_GPG1(5), S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE},  /* WLAN_SDIO_D(2) HW PULL_UP */
   {S5PV210_GPG1(6), S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE},  /* WLAN_SDIO_D(3) HW PULL_UP */
   ...
   {S5PV210_GPG3(1), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},  /* MASSMEMORY_EN HW PULL_DOWN */ // TODO:MoviNAND DBdata crash
   ...
   /* GPJ0 */
   {S5PV210_GPJ0(0), S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN},  /* POPUP_SW_EN */
   {S5PV210_GPJ0(1), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* BUCK1_EN_B */
//   {S5PV210_GPJ0(2), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},  /* CAM_FLASH_SET HW PULL_DOWN */
   {S5PV210_GPJ0(2), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},  /* CAM_FLASH_SET HW PULL_DOWN */
   {S5PV210_GPJ0(3), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},  /* NC */
   {S5PV210_GPJ0(4), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},  /* NC */
   {S5PV210_GPJ0(5), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* NC */
   {S5PV210_GPJ0(6), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* NC */
   {S5PV210_GPJ0(7), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* CAM_FLASH_EN HW PULL_DOWN */
// {S5PV210_GPJ0(7), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},  /* CAM_FLASH_EN HW PULL_DOWN */
   ...
   {S5PV210_GPJ1(4), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* NC */
   {S5PV210_GPJ1(5), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},  /* NC */

   /* GPJ2 - dpram */
   {S5PV210_GPJ2(0), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* CP_EBI2_AD(0) */
   {S5PV210_GPJ2(1), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},
   {S5PV210_GPJ2(2), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},
   {S5PV210_GPJ2(3), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},
   {S5PV210_GPJ2(4), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},
   {S5PV210_GPJ2(5), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},
   {S5PV210_GPJ2(6), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},
   {S5PV210_GPJ2(7), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* CP_EBI2_AD(7) */

   /* GPJ3 - dpram */
	{S5PV210_GPJ3(0), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},
   ...
   {S5PV210_GPJ3(6), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},
   {S5PV210_GPJ3(7), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* CP_EBI2_AD(15) */
   ...
   {S5PV210_MP01(0), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},  /* MAIN_KEY_LED_EN(NC) ~ HW Rev0.6 */
   {S5PV210_MP01(1), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},  /* LCD_CS */
   {S5PV210_MP01(2), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* LTE_OP_MODE_0 */
   {S5PV210_MP01(3), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},  /* UART_SEL1 */
   {S5PV210_MP01(4), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},  /* AP_NANDCS */
   {S5PV210_MP01(5), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* LTE_OP_MODE_1 */
   ...
   {S5PV210_MP02(2), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* VCC_1.8V_PDA */
   {S5PV210_MP02(3), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},  /* NC : EBI_DATA_RDn */
   ...
   {S5PV210_MP04(0), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* For new MAIN_KEY_LED of HW 0.7 */
   ...
   {S5PV210_MP05(5), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},   /* LTE_DP_INT */
...
{
	{S5PV210_GPH0(0), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_UP},
//	{S5PV210_GPH0(1), S3C_GPIO_EINT,  S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_DOWN}, // VOUT_PS
//	{S5PV210_GPH0(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, // 3_SEND_END (Active High)
	{S5PV210_GPH0(3), S3C_GPIO_EINT,  S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE}, // WLAN_HOST_WAKE
	{S5PV210_GPH0(4), S3C_GPIO_EINT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, // BT_HOST_WAKE
...
//	{S5PV210_GPH0(7), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, // AP_PMIC_IRQ (HW PULL_UP)
	{S5PV210_GPH1(0), S3C_GPIO_EINT,  S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE}, // LTE_ACTIVE (HW Pull-down)
//	{S5PV210_GPH1(0), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, // LTE_ACTIVE (HW Pull-down)
	{S5PV210_GPH1(1), S3C_GPIO_EINT,   S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE},   // DPRAM_C111_INT_N
...
//	{S5PV210_GPH1(5), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN},   // SEND_END (active low)
...
//	{S5PV210_GPH2(0), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_UP}, // KEY_SCAN(0)
	{S5PV210_GPH2(1), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, // KEY_SCAN(1)
	{S5PV210_GPH2(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, // KEY_SCAN(2)
	{S5PV210_GPH2(3), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, // KEY_SCAN(3)
	{S5PV210_GPH2(4), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, // KEY_SCAN(4)
	{S5PV210_GPH2(5), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN},// KEY_SCAN(5)
...
//	{S5PV210_GPH3(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, // VT_CAM_EN
	{S5PV210_GPH3(1), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN},   // VT_CAM_RST
    {S5PV210_GPH3(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, // VT_CAM_EN
