...
static unsigned int initial_gpio_table[][4] =
{
    ...
    {S5PV210_GPA0(5), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, /* NC */
	...
	{S5PV210_GPA1(2), S3C_GPIO_OUTPUT,S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, /* CP_RST */
   ...
   {S5PV210_GPB(2),  S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	...
	{S5PV210_GPC0(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, /*NC */ 
	...
	{S5PV210_GPC1(3), S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE}, 	//HDMI_EN1
	...
	{S5PV210_GPD0(3), S3C_GPIO_EINT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_UP  },  /* TSP_INT*/ 
	...
	{S5PV210_GPH2(7), S3C_GPIO_EINT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
	...
	{S5PV210_GPJ0(1), S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPJ0(2), S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPJ0(3), S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPJ0(4), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPJ0(5), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, 
	...
	{S5PV210_GPJ1(4), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, 
...
#endif   // heatup
	// MP01 --------------------------------------------------------------------
	{S5PV210_MP01(0), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_MP01(1), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE,  S3C_GPIO_PULL_NONE}, 
...
//	{S5PV210_MP01(7), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	...
	// MP02 --------------------------------------------------------------------
	{S5PV210_MP02(0), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE}, 
...
//	{S5PV210_MP05(3), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
    ...
    {S5PV210_MP05(7), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE},
#else
	{S5PV210_MP05(4), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_MP05(6), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
#endif   // heatup
...
static unsigned int sleep_gpio_table[][3] =
{
   ...
   /* GPA1 */
	{S5PV210_GPA1(0), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_DOWN},  /* AP_RXD */
 	...
 	{S5PV210_GPA1(3), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},    /* KEY_SCAN(7) */ // TODO:YUNG_RECHECK
   ...
   {S5PV210_GPB(4), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},   /* BL_SCL HW PULL_UP */
   {S5PV210_GPB(5), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},   /* BL_SDA HW PULL_UP */
   {S5PV210_GPB(6), S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN},   /* BUCK1_EN_A   */
   {S5PV210_GPB(7), S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN},   /* BUCK2_EN     */

   /* GPC0 */
   {S5PV210_GPC0(0), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},  /* NC       */
   {S5PV210_GPC0(1), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},  /* LCD_CLK  */
   {S5PV210_GPC0(2), S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN},  /* LCD_ID   */
   ...
   {S5PV210_GPF3(5), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},    /* LTE_WAKE_INT */ // TODO:LTE
   ...
   {S5PV210_GPG2(2), S3C_GPIO_SLP_INPUT,S3C_GPIO_PULL_DOWN},   /* LCD_BL_EN check HW Pull-up */
   ...
   /* GPJ0 */
   {S5PV210_GPJ0(0), S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},  /* POPUP_SW_EN (MICBIAS_EN1) */
   {S5PV210_GPJ0(1), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},  /* BUCK1_EN_B */
   {S5PV210_GPJ0(2), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},  /* CAM_FLASH_SET HW PULL_DOWN */
   {S5PV210_GPJ0(3), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},  /* NC */
   {S5PV210_GPJ0(4), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},  /* NC */
   {S5PV210_GPJ0(5), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},  /* NC */
   {S5PV210_GPJ0(6), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},  /* NC */
   {S5PV210_GPJ0(7), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},  /* CAM_FLASH_EN HW PULL_DOWN */
   ...
   {S5PV210_GPJ1(4), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},  /* NC */
   ...
   {S5PV210_MP05(5), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},    /* LTE_DP_INT */
...
{
	{S5PV210_GPH0(0), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_UP}, // VOUT_PS
...
//	{S5PV210_GPH0(3), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, // WLAN_HOST_WAKE
...
//	{S5PV210_GPH0(6), S3C_GPIO_EINT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, // EAR_DET (HW PULL_UP)
...
//	{S5PV210_GPH1(1), S3C_GPIO_EINT,   S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_UP},   // DPRAM_C111_INT_N
	{S5PV210_GPH1(2), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_UP}, // CMC_RESET
//	{S5PV210_GPH1(3), S3C_GPIO_EINT,   S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_UP},   // INT_ONEDRAM_AP_N
	...
	{S5PV210_GPH1(5), S3C_GPIO_EINT,   S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_DOWN},
...
//	{S5PV210_GPH1(7), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, // PHONE_ACTIVE(QSC_ACTIVE)
	...
	{S5PV210_GPH2(0), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, // KEY_SCAN(0)
	{S5PV210_GPH2(1), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, // KEY_SCAN(1)
//	{S5PV210_GPH2(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_UP}, // KEY_SCAN(2)/
//	{S5PV210_GPH2(3), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_UP}, // KEY_SCAN(3)
	{S5PV210_GPH2(4), S3C_GPIO_EINT,  S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_DOWN}, // KEY_SCAN(4)
	{S5PV210_GPH2(5), S3C_GPIO_EINT,  S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_DOWN}, // KEY_SCAN(5)
...
//	{S5PV210_GPH3(0), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ONE,  S3C_GPIO_PULL_UP}, // KEYSENS(0) (HW PULL-UP)
//	{S5PV210_GPH3(1), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_UP},   // VOLUME_DOWN
//	{S5PV210_GPH3(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_UP}, // VT_CAM_EN
//	{S5PV210_GPH3(3), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_UP}, // NC (HW PULL-UP)
	{S5PV210_GPH3(4), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_UP}, // NC (HW PULL-UP)
	{S5PV210_GPH3(5), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_UP}, // GYRO_DRDY (Active High?)
	{S5PV210_GPH3(6), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, // NC (HW PULL-UP)
	{S5PV210_GPH3(7), S3C_GPIO_EINT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_UP}, // T_FLASH_DETECT disabled in suspend
};
