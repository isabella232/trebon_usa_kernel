...
/* modified 2.2 Gamma Table for MTP Panel */
...
static const u16 acl_cutoff_40p[] = {
	...
	0x100,	0x100,	0x103,	0x11F,
	0x100,  0x100,  0x100,  0x100,
	0x100,  0x101,  0x106,  0x10C,
	0x111,  0x116,  0x11C,  0x121,
	0x126,  0x12B,  0x131,  0x136,
...
static const u16 acl_cutoff_43p[] = {
	...
	0x100,	0x100,	0x103,	0x11F,
	0x100,  0x100,  0x100,  0x100,
	0x100,  0x101,  0x107,  0x10C,
	0x112,  0x118,  0x11E,  0x123,
	0x129,  0x12F,  0x134,  0x13A,
...
static const u16 acl_cutoff_45p[] = {
	...
	0x100,	0x100,	0x103,	0x11F,
	0x100,  0x100,  0x100,  0x100,
	0x100,  0x101,  0x107,  0x10D,
	0x113,  0x119,  0x11F,  0x125,
	0x12B,  0x131,  0x137,  0x13D,
...
static const u16 acl_cutoff_47p[] = {
	...
	0x100,	0x100,	0x103,	0x11F,
	0x100,  0x100,  0x100,  0x100,
	0x100,  0x101,  0x107,  0x10E,
	0x114,  0x11B,  0x121,  0x127,
	0x12E,  0x134,  0x13B,  0x141,
...
static const u16 acl_cutoff_48p[] = {
	...
	0x100,	0x100,	0x103,	0x11F,
	0x100,  0x100,  0x100,  0x100,
	0x100,  0x101,  0x108,  0x10E,
	0x115,  0x11B,  0x122,  0x129,
	0x12F,  0x136,  0x13C,  0x143,
...
struct s5p_panel_data aries_panel_data = {
	...
	.gpio_dcx = S5PV210_GPF0(0), /* H_SYNC pad */
       ...
       .gpio_wrx = S5PV210_GPC0(1), /* SCL pad */
       .gpio_rst = S5PV210_GPC0(4),
       .gpio_db = {
                S5PV210_GPF0(4),
                S5PV210_GPF0(5),
                S5PV210_GPF0(6),
