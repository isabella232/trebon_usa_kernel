...
extern void fan5403_set_charge_current(int curr);
#endif
...
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_FIMC0 (8688 * SZ_1K)	// buffer 6
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_FIMC1 (9900 * SZ_1K)
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_FIMC2 (8688 * SZ_1K)	// buffer 6
...
static struct max8998_charger_data aries_charger = {
	...
	.temp_high_event_threshold	= 237,	// 60
	.temp_high_threshold	= 237,	// 60
	.temp_high_recovery	= 221,	// 42
	.temp_low_recovery	= 162,	// 0
	.temp_low_threshold	= 158,	// -5
	.temp_high_threshold_lpm	= 236,	// 60
	.temp_high_recovery_lpm 	= 227,	// 42
...
{
#ifdef CONFIG_CHARGER_FAN5403
	fan5403_set_charge_current(CHG_CURR_USB);
#endif
...
{
#ifdef CONFIG_CHARGER_FAN5403
	fan5403_set_charge_current(CHG_CURR_TA);
#endif
...
#ifdef CONFIG_AEGIS_USCC
#ifdef CONFIG_BATTERY_MAX17043
	.rcomp_value = 0xE01F,	// ATHD 1%
#else
	.rcomp_value = 0xE000,	// Aegis USCC (1800mAh standard battery)
#endif
	.psoc_full	= 9500, // 95.0%
	.psoc_empty	= 30,	// 0.3%
#else /* CONFIG_AEGIS_USCC */
#ifdef CONFIG_BATTERY_MAX17043
	.rcomp_value = 0xC01F,	// ATHD 1%
#else
	.rcomp_value = 0xC000,	// Aegis Verizon (1800mAh standard battery)
#endif
	.psoc_full	= 9560, // 95.6%
	.psoc_empty	= 30,	// 0.3%
#endif /* CONFIG_AEGIS_USCC */
};
