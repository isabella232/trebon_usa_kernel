...
static struct max8998_charger_data aries_charger = {
	...
	.temp_high_event_threshold	= 220,
	.temp_high_threshold	= 220,
	.temp_high_recovery	= 191,
	.temp_low_recovery	= 116,
	.temp_low_threshold	= 109,
	.temp_high_threshold_lpm	= 220,
	.temp_high_recovery_lpm		= 191,
	.temp_low_recovery_lpm		= 116,
	.temp_low_threshold_lpm		= 109,
...
static struct sec_jack_buttons_zone sec_jack_buttons_zones[] = {
	{
		/* 0 <= adc <= 83, stable zone */
		.code		= KEY_MEDIA,
		.adc_low	= 0,
		.adc_high	= 93,
	},
	{
		/* 95 <= adc <= 230, stable zone */
		.code		= KEY_VOLUMEUP,
		.adc_low	= 95,
		.adc_high	= 230,
	},
	{
		/* 260 <= adc <= 268, stable zone */
		.code		= KEY_VOLUMEDOWN,
		.adc_low	= 260,
		.adc_high	= 268,
	},
	{
		/* 335 <= adc <= 520, stable zone */
		.code		= KEY_VOLUMEDOWN,
		.adc_low	= 335,
		.adc_high	= 520,
	},
