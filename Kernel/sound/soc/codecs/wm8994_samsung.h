...
#define CONFIG_VOIP_EXT         /* For VoIP apps, not use MODE_IN_COMMUNICATION */
#define CONFIG_VOLTE            /* For VOLTE app */
#define CONFIG_VOIP_GTALK       /* For GTalk VoIP app */
...
#ifdef CONFIG_VOLTE
#define PLAYBACK_VOLTE_RCV	(0x01 << 15)
#define PLAYBACK_VOLTE_SPK	(0x01 << 16)
#define PLAYBACK_VOLTE_HP	(0x01 << 17)
#define PLAYBACK_VOLTE_BT	(0x01 << 18)
#endif
#ifdef CONFIG_VOIP_GTALK
#define PLAYBACK_GTALK_RCV      (0x01 << 19)
#define PLAYBACK_GTALK_SPK      (0x01 << 20)
#define PLAYBACK_GTALK_HP       (0x01 << 21)
#define PLAYBACK_GTALK_BT       (0x01 << 22)
#endif
...
#ifdef CONFIG_VOLTE
#define RECORDING_VOLTE_MAIN	(0x01 << 17)
#define RECORDING_VOLTE_MAIN2	(0x01 << 18)
#define RECORDING_VOLTE_HP	(0x01 << 19)
#define RECORDING_VOLTE_BT	(0x01 << 20)
#endif
#ifdef CONFIG_VOIP_GTALK
#define RECORDING_GTALK_MAIN	(0x01 << 21)
#define RECORDING_GTALK_MAIN2	(0x01 << 22)
#define RECORDING_GTALK_HP	(0x01 << 23)
#define RECORDING_GTALK_BT	(0x01 << 24)
#endif
...
#ifdef CONFIG_VOLTE
#ifdef CONFIG_VOIP_GTALK
#define PLAYBACK_GAIN_NUM       88
#else
#define PLAYBACK_GAIN_NUM	74
#endif
#else /* CONFIG_VOLTE */
#ifdef CONFIG_VOIP_GTALK
#define PLAYBACK_GAIN_NUM       74
...
#ifdef CONFIG_VOLTE
#ifdef CONFIG_VOIP_GTALK
#define RECORDING_GAIN_NUM      72
#else
#define RECORDING_GAIN_NUM	60
#endif
#else /* CONFIG_VOLTE */
#ifdef CONFIG_VOIP_GTALK
#define RECORDING_GAIN_NUM      60
#else
#define RECORDING_GAIN_NUM	48
#endif
#endif /* CONFIG_VOLTE */
...
#endif
#ifdef CONFIG_VOLTE
#define CMD_VOLTE_ACTIVE                13 /* Start VoLTE */
#define CMD_VOLTE_DEACTIVE              14 /* Stop VoLTE */
#endif
#ifdef CONFIG_VOIP_GTALK
#define CMD_VOIP_GTALK_ACTIVE           15 /* Start GTalk */
#define CMD_VOIP_GTALK_DEACTIVE         16 /* Stop GTalk */
#endif
#define CMD_VOICE_RECORDER_AMR_ACTIVE	17 /* Start AMR recording */
#define CMD_VOICE_RECORDER_AMR_DEACTIVE	18 /* Stop AMR recording */
...
#endif
#ifdef CONFIG_VOLTE
	int volte_active_flag;
#endif
#ifdef CONFIG_VOIP_GTALK
        int gtalk_active_flag;
#endif
	int amr_rec_flag;
#ifdef CONFIG_DVFS_LIMIT
        int voip_dvfs_lock_flag;
#endif
