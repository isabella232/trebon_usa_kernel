...
#define CHG_CURR_TA_EVENT	SMB328A_CURR_900
#else
#define CHG_CURR_TA		SMB328A_CURR_900
#define CHG_CURR_TA_EVENT	SMB328A_CURR_900
#endif
#else
#define CHG_CURR_TA		SMB328A_CURR_1200
#define CHG_CURR_TA_EVENT	SMB328A_CURR_1200
#endif
...
#define CHG_AC_LIMIT_TA     SMB328A_LIMIT_1000
#else
#define CHG_AC_LIMIT_TA		SMB328A_LIMIT_900
#endif
...
#ifdef CONFIG_TIKAL_MPCS
#define CHG_TERM_CURR	SMB328A_TERM_175
#elif defined CONFIG_MACH_TREBON
#define CHG_TERM_CURR   SMB328A_TERM_125
#else
#define CHG_TERM_CURR	SMB328A_TERM_200
#endif
